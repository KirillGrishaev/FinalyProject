...
<body>
<img src="${pageContext.request.contextPath}/img/buy.jpg" class="background" />
<header>
  <div class="topnav">
    <a href="${pageContext.request.contextPath}/index/index_action.jsp">Проходная</a>
    <a class="active" href="/Dark_Valley/catalogViewAll">Весь каталог</a>
    ...
    <a href="/Dark_Valley/clientCabinet">Личный кабинет</a>
  ...
  <hgroup>
    ...
    <h1><a href="${pageContext.request.contextPath}/client/basket.jsp">Проверить авоську</a></h1>
  </hgroup>
</header>
</body>
</html>